...
(function () {
  ...
  squiz.fn.sampleFunction = function () {}; // Make squiz variable available to the console for debugging
...
(function () {
  'use strict'; // toggles hamburger menu
  ...
  var desktopBreakPoint = window.matchMedia("(min-width: 64rem)"); // Checking view port and set to store if mobile or not
  ...
  var searchButton = document.querySelector('.search-bar-icon');
  ...
  var tabletBreakPoint = window.matchMedia("(min-width: 48rem)");
...
(function () {
  'use strict'; //sidenav sub menu

  var sideNavButtons = document.querySelectorAll('.smp-subnav__title button'); // forEach only supported on IE9 and above for arrays but not for NodeList

  var sideNavBtnsArray = Array.prototype.slice.call(sideNavButtons);
  sideNavBtnsArray.forEach(function (button) {
    var liContainer = button.parentNode.parentElement;
    var thirdLevel = button.parentNode.parentNode.lastElementChild;
...
// CONCATENATED MODULE: ./src/modules/HomeBanner/js/global.js


(function () {
  'use strict';

  var carousel = document.querySelector('.glide');
